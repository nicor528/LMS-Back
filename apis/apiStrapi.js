...
function getCourses () {
    return(
        new Promise (async (res, rej) => {
            fetch(`${process.env.url}/lms-courses?populate[lms_modules][populate][lms_mentors][populate][imageUrl][lms_annoucements][populate][lms_technologies][lms_quiz][populate]=*`, {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${process.env.STRAPI_TOKEN}`,
                    "Content-Type": 'application/json',
...
function getOneCourse (id) {
    return(
        new Promise (async (res, rej) => {
            fetch(`${process.env.url}/lms-courses/${id}?populate[lms_modules][lms_mentors][imageUrl][lms_annoucements][lms_technologies][lms_quiz][populate]=*`, {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${process.env.STRAPI_TOKEN}`,
                    "Content-Type": 'application/json',
